export const TAXONOMY: Record<string, Record<string, string[]>> = {
  top: {
    ...
    'Swimwear': ['Bikini Top', 'Rash Guard', 'Swim Crop Top', 'Other'],
    'Other': ['Other'],
  },
  bottom: {
    'Denim': ['Distressed', 'Raw / Selvedge', 'Acid Wash', 'Coated', 'Other'],
    'Trousers': ['Pleated', 'Chinos', 'Dress Pants', 'Suit Trousers', 'Linen Trousers', 'Cargo Trousers', 'Other'],
    'Shorts': ['Chino Shorts', 'Denim Shorts', 'Athletic Shorts', 'Bermuda', 'Cargo Shorts', 'Biker Shorts', 'Other'],
    ...
    'Swimwear': ['Swim Trunks', 'Board Shorts', 'Swim Briefs', 'Bikini Bottom', 'Other'],
    'Other': ['Other'],
  },
  full_body: {
    ...
    'Swimwear': ['One-Piece Swimsuit', 'Tankini', 'Swim Dress', 'Other'],
    'Other': ['Other'],
  },
  shoes: {
  ...
  outerwear: {
    'Jackets': ['Bomber', 'Denim Jacket', 'Leather Jacket', 'Moto Jacket', 'Track Jacket', 'Windbreaker', 'Field Jacket', 'Blazer', 'Suit Jacket', 'Other'],
  ...
  accessory: {
    ...
    'Ties & Pocket Squares': ['Necktie', 'Bow Tie', 'Skinny Tie', 'Knit Tie', 'Bolo Tie', 'Pocket Square', 'Other'],
