...
const styles = StyleSheet.create({
  ...
  optionTitle: { fontSize: typography.text.body.fontSize, color: colors.foreground, fontWeight: typography.weight.semibold },
  optionSubtitle: { fontSize: typography.text.caption.fontSize, lineHeight: 17, color: colors.mutedForeground },
  radioOutline: {
  ...
  cancelButtonText: { fontSize: typography.text.bodySmall.fontSize, color: colors.foreground, fontWeight: typography.weight.semibold },
  primaryButton: {
    flex: 1, minHeight: 44, alignItems: 'center', justifyContent: 'center',
    borderRadius: radii.full, backgroundColor: colors.primary,
  },
  buttonDisabled: { opacity: 0.45 },
  primaryButtonText: { fontSize: typography.text.bodySmall.fontSize, color: colors.primaryForeground, fontWeight: typography.weight.semibold },
});
