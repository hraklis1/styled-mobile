          ...
          for (const line of lines) {
            if (line.startsWith('event: ')) {
              ...
              if (currentEvent === 'done') {
                ...
                const { transcript, responseText, itemIds, missingEssentials: mes, missingEssential: legacyMe, shopOutfit, tripPlan, mode: respMode, recId } =
                  parsed as { transcript: string; responseText: string; itemIds?: number[]; missingEssentials?: MissingEssential[]; missingEssential?: { label: string; category: string; reason: string } | null; shopOutfit?: ShopOutfit | null; tripPlan?: TripPlanData | null; mode?: StylistMode; recId?: number | null };
