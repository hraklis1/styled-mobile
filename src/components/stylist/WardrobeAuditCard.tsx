...
const styles = StyleSheet.create({
  ...
  summary: { ...typography.text.body, color: colors.inkSubtle },
  section: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.border, padding: spacing.lg, gap: spacing.md },
  sectionTitle: { ...typography.text.eyebrow, color: colors.primary },
  bulletList: { gap: spacing.sm },
  bulletRow: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm },
  bullet: { width: 5, height: 5, borderRadius: 3, backgroundColor: colors.primary, marginTop: 7 },
  bulletText: { flex: 1, fontSize: typography.text.bodySmall.fontSize, lineHeight: 20, color: colors.foreground },
  emptyText: { fontSize: typography.text.bodySmall.fontSize, lineHeight: 20, color: colors.mutedForeground },
  ...
  itemName: { fontSize: typography.text.body.fontSize, fontWeight: typography.weight.medium, color: colors.foreground },
