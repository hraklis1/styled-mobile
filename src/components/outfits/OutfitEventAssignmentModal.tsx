...
const styles = StyleSheet.create({
  ...
  cancel: { color: colors.mutedForeground, fontSize: typography.text.body.fontSize },
  title: { color: colors.foreground, fontSize: typography.text.body.fontSize, fontWeight: typography.weight.semibold },
  save: { color: colors.primary, fontSize: typography.text.body.fontSize, fontWeight: typography.weight.semibold },
  ...
  eventTitle: { color: colors.foreground, fontSize: typography.text.bodySmall.fontSize, fontWeight: typography.weight.semibold },
  eventMeta: { color: colors.mutedForeground, fontSize: typography.text.caption.fontSize },
  replacement: { color: colors.primary, fontSize: typography.text.caption.fontSize, marginTop: 2 },
  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: spacing.xxxl, gap: spacing.sm },
  emptyTitle: { color: colors.foreground, fontSize: typography.text.body.fontSize, fontWeight: typography.weight.semibold },
  emptyText: { color: colors.mutedForeground, fontSize: typography.text.bodySmall.fontSize, textAlign: 'center' },
});
