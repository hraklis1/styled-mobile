...
const styles = StyleSheet.create({
  ...
  sortText: { fontSize: typography.text.bodySmall.fontSize, color: colors.mutedForeground },
  ...
  doneText: { fontSize: typography.text.body.fontSize, fontWeight: typography.weight.semibold, color: colors.primaryForeground },
});
