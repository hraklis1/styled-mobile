...
const styles = StyleSheet.create({
  ...
  closeButton: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.muted },
  scroll: { flexShrink: 1 },
  ...
  optionalLabel: { ...typography.text.caption, color: colors.mutedForeground },
  input: { minHeight: 48, borderRadius: radii.md, borderCurve: 'continuous', borderWidth: 1, borderColor: colors.border, backgroundColor: colors.card, paddingHorizontal: spacing.md, fontSize: typography.text.body.fontSize, color: colors.foreground },
  notesInput: { minHeight: 84, paddingTop: spacing.md },
  chipWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  chip: { minHeight: 44, justifyContent: 'center', borderRadius: 19, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.card, paddingHorizontal: spacing.md },
  chipSelected: { borderColor: colors.primary, backgroundColor: colors.primary },
  chipText: { fontSize: typography.text.bodySmall.fontSize, color: colors.foreground },
  ...
  selectionText: { flex: 1, fontSize: typography.text.body.fontSize, color: colors.foreground },
  ...
  dateText: { flex: 1, fontSize: typography.text.bodySmall.fontSize, color: colors.foreground, fontVariant: ['tabular-nums'] },
  ...
  validationText: { fontSize: typography.text.caption.fontSize, color: colors.mutedForeground, textAlign: 'center' },
