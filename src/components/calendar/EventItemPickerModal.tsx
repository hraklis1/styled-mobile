...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: typography.text.body.fontSize, fontWeight: typography.weight.semibold, color: colors.foreground },
  cancelText: { fontSize: typography.text.body.fontSize, color: colors.mutedForeground },
  saveText: { fontSize: typography.text.body.fontSize, fontWeight: typography.weight.semibold, color: colors.primary, textAlign: 'right' },
  ...
  searchInput: {
    ...
    paddingHorizontal: spacing.md, fontSize: typography.text.bodySmall.fontSize,
    lineHeight: typography.inputLineHeight(typography.text.bodySmall.fontSize), color: colors.foreground,
  },
  ...
  catLabel: { fontSize: typography.text.caption.fontSize, fontWeight: typography.weight.medium, color: colors.mutedForeground },
  ...
  itemThumbInitials: { fontSize: typography.text.caption.fontSize, fontWeight: typography.weight.bold, color: colors.mutedForeground },
  itemInfo: { flex: 1, gap: 2 },
  itemName: { fontSize: typography.text.bodySmall.fontSize, fontWeight: typography.weight.medium, color: colors.foreground },
  itemMeta: { fontSize: typography.text.caption.fontSize, color: colors.mutedForeground },
  checkbox: {
  ...
  checkmark: { ...typography.text.label, color: colors.white },
  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: spacing.xxxl },
  emptyText: { fontSize: typography.text.bodySmall.fontSize, color: colors.mutedForeground, textAlign: 'center' },
  clearBtn: {
    margin: spacing.lg, paddingVertical: spacing.md,
    borderRadius: radii.md, borderWidth: 1, borderColor: colors.border,
    alignItems: 'center',
  },
  clearBtnText: { fontSize: typography.text.bodySmall.fontSize, color: colors.mutedForeground },
});
