...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontFamily: typography.family.display, fontSize: typography.size.xxl, color: colors.foreground },
  price: { fontFamily: typography.family.display, fontSize: typography.size.xl, color: colors.foreground, fontVariant: ['tabular-nums'] },
  priceMuted: { fontFamily: typography.family.display, fontSize: typography.size.lg, color: colors.mutedForeground },
  meta: { fontSize: typography.size.sm, letterSpacing: 0.4, textTransform: 'uppercase', color: colors.mutedForeground },
  divider: { height: StyleSheet.hairlineWidth, marginVertical: spacing.sm, backgroundColor: colors.hairline },
  specs: { fontSize: typography.size.xs, letterSpacing: 0.3, color: colors.secondaryForeground, fontVariant: ['tabular-nums'] },
  notes: { fontSize: typography.size.md, lineHeight: 24, fontStyle: 'italic', color: colors.secondaryForeground },
  ...
  actionPillText: { fontSize: typography.size.xs, fontWeight: typography.weight.semibold, color: colors.foreground },
  ...
  catalogFieldLabel: { fontSize: 10, fontWeight: typography.weight.bold, letterSpacing: 1, color: colors.mutedForeground, textTransform: 'uppercase' },
  catalogFieldInput: {
    paddingVertical: 6,
  ...
  catalogStatusText: { fontSize: 11, fontWeight: typography.weight.semibold, color: colors.secondaryForeground },
  ...
  catalogSaveText: { fontSize: typography.size.xs, fontWeight: typography.weight.semibold, color: colors.primaryForeground },
  stylistRow: {
  ...
  stylistRowText: { flex: 1, fontSize: typography.size.xs, fontWeight: typography.weight.semibold, color: colors.primary },
  ...
  badgeText: { fontSize: typography.size.xs, fontWeight: typography.weight.medium, color: colors.mutedForeground },
  detailsEyebrow: { fontSize: 10, fontWeight: typography.weight.bold, letterSpacing: 1.5, color: colors.primary },
  detailRows: { gap: spacing.sm, paddingTop: spacing.xs },
  detailRow: { flexDirection: 'row', justifyContent: 'space-between', gap: spacing.md },
  detailLabel: { fontSize: typography.size.xs, fontWeight: typography.weight.semibold, color: colors.mutedForeground },
  detailValue: { flex: 1, fontSize: typography.size.sm, textAlign: 'right', color: colors.foreground },
  disclosureCard: {
  ...
  tagHeader: { fontSize: 10, fontWeight: typography.weight.bold, letterSpacing: 1.2, color: colors.primary, marginTop: spacing.xs },
  tagListRow: { flexDirection: 'row', gap: spacing.xs },
  tagBullet: { fontSize: typography.size.sm, lineHeight: 21, color: colors.secondaryForeground },
  tagItemText: { flex: 1, fontSize: typography.size.sm, lineHeight: 21, color: colors.secondaryForeground },
  tagText: { fontSize: typography.size.sm, lineHeight: 21, color: colors.secondaryForeground },
  deleteTouch: { alignSelf: 'flex-start', marginTop: spacing.lg, paddingVertical: spacing.xs },
  deleteText: { fontSize: typography.size.xs, fontWeight: typography.weight.semibold, color: colors.error },
  closeButton: {
    position: 'absolute',
    right: spacing.lg,
    width: 36,
