...
const s = StyleSheet.create({
  ...
  errorText: { fontSize: typography.text.caption.fontSize, color: colors.error, lineHeight: 17 },
  selectRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  selectText: { fontSize: typography.text.bodySmall.fontSize, color: colors.foreground },
  nativePickerRow: {
    minHeight: 48,
  ...
  occasionLabel: { fontSize: typography.text.caption.fontSize, fontWeight: typography.weight.medium, color: colors.mutedForeground },
  ...
  detailsToggleTitle: { fontSize: typography.text.bodySmall.fontSize, color: colors.foreground, fontWeight: typography.weight.semibold },
  detailsToggleText: { ...typography.text.caption, color: colors.mutedForeground, marginTop: 2 },
  ...
  envLabel: { fontSize: typography.text.caption.fontSize, fontWeight: typography.weight.medium, color: colors.mutedForeground },
