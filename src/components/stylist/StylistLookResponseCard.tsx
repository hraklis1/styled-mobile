...
const styles = StyleSheet.create({
  ...
  gapCount: { ...typography.eyebrow, color: colors.action },
  title: { fontFamily: typography.family.display, fontSize: typography.display.md.fontSize, lineHeight: typography.display.md.lineHeight, color: colors.foreground },
  body: { fontSize: typography.size.md, lineHeight: typography.size.md * 1.5, color: colors.inkSubtle },
  collageWrap: { backgroundColor: colors.card, borderRadius: radii.lg, overflow: 'hidden', alignItems: 'center' },
  section: { gap: spacing.sm },
  sectionLabel: { ...typography.eyebrow, color: colors.mutedForeground },
  ...
  ledgerText: { fontSize: typography.size.xs, lineHeight: 15, color: colors.secondaryForeground },
  ...
  primaryButtonText: { color: colors.primaryForeground, fontSize: typography.size.md, fontWeight: typography.weight.semibold },
  ...
  secondaryButtonText: { color: colors.primary, fontSize: typography.size.sm, fontWeight: typography.weight.semibold },
  quietButton: { minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: spacing.xs, paddingHorizontal: spacing.sm },
  quietText: { color: colors.mutedForeground, fontSize: typography.size.sm },
  ...
  optionText: { flex: 1, color: colors.foreground, fontSize: typography.size.md, fontWeight: typography.weight.medium },
  safestButton: { minHeight: 44, alignItems: 'center', justifyContent: 'center' },
  safestText: { color: colors.action, fontSize: typography.size.sm, fontWeight: typography.weight.semibold },
});
