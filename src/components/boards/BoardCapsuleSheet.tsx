...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontSize: typography.text.sectionTitle.fontSize, fontWeight: typography.weight.bold, color: colors.foreground },
  ...
  emptyTitle: { color: colors.foreground, fontSize: typography.text.body.fontSize, fontWeight: typography.weight.semibold, textAlign: 'center' },
  hint: { color: colors.mutedForeground, fontSize: typography.text.caption.fontSize, textAlign: 'center' },
  retryBtn: {
    minHeight: 44,
