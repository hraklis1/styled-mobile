...
const styles = StyleSheet.create({
  ...
  fallbackText: { fontSize: typography.text.caption.fontSize, color: colors.mutedForeground },
  ...
  unsortedText: { ...typography.text.caption, fontWeight: typography.weight.medium, color: colors.primary },
  ...
  roleText: { flex: 1, ...typography.text.caption, color: colors.mutedForeground },
  priceText: { flexShrink: 0, fontSize: typography.text.bodySmall.fontSize, fontWeight: typography.weight.semibold, color: colors.foreground, fontVariant: ['tabular-nums'] },
  catalogText: { ...typography.text.caption, fontWeight: typography.weight.semibold, color: colors.primary },
