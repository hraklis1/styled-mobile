...
const styles = StyleSheet.create({
  ...
  title: { fontSize: typography.size.lg, fontWeight: typography.weight.bold, color: colors.foreground },
  ...
  info: { flex: 1 },
  name: { fontSize: typography.size.md, fontWeight: typography.weight.medium, color: colors.foreground },
  count: { fontSize: typography.size.xs, color: colors.mutedForeground },
  empty: { fontSize: typography.size.sm, color: colors.mutedForeground, paddingVertical: spacing.lg },
});
