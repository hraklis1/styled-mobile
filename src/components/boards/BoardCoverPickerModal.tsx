...
const styles = StyleSheet.create({
  ...
  actionInfo: { flex: 1 },
  actionTitle: { color: colors.foreground, fontSize: typography.text.bodySmall.fontSize, fontWeight: typography.weight.semibold },
  actionCopy: { color: colors.mutedForeground, fontSize: typography.text.caption.fontSize },
  sectionTitle: { paddingHorizontal: spacing.lg, paddingBottom: spacing.sm, color: colors.foreground, fontSize: typography.text.body.fontSize, fontWeight: typography.weight.bold },
  ...
  empty: { paddingTop: spacing.xl, color: colors.mutedForeground, fontSize: typography.text.bodySmall.fontSize, textAlign: 'center' },
});
