...
const styles = StyleSheet.create({
  ...
  title: { color: colors.foreground, fontSize: typography.text.body.fontSize, fontWeight: typography.weight.bold },
  subtitle: { color: colors.mutedForeground, fontSize: typography.text.caption.fontSize, fontVariant: ['tabular-nums'] },
  ...
  searchInput: { flex: 1, minHeight: 46, color: colors.foreground, fontSize: typography.text.body.fontSize, lineHeight: typography.inputLineHeight(typography.text.body.fontSize) },
  ...
  rowTitle: { color: colors.foreground, fontSize: typography.text.bodySmall.fontSize, fontWeight: typography.weight.semibold },
  rowSubtitle: { color: colors.mutedForeground, fontSize: typography.text.caption.fontSize },
  rowMeta: { color: colors.mutedForeground, fontSize: typography.text.caption.fontSize, fontVariant: ['tabular-nums'] },
  empty: { paddingTop: spacing.xxxl, textAlign: 'center', color: colors.mutedForeground, fontSize: typography.text.bodySmall.fontSize },
});
